...
## autojump: see plugin autojump: https://github.com/wting/autojump


## z: see plugin z: https://github.com/rupa/z
...
## fd is a great replacement for the venerable find.
...
## search in PDFs, E-Books and Office documents in current directory.allowed extensions: .epub, .odt, .docx, .fb2, .ipynb, .pdf.
...
## use Ag to search files and display results in ranger's pager. not production ready
import re
class ag(Command):
    """:ag 'regex'
